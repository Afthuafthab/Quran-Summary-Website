...
const INPUT_PATH = '../.hermes/desktop-attachments/Volume 4 - part 2.txt'
const TARGET_CHAPTERS = Array.from({length: 6}, (_, i) => 12 - i) // 12..7
...
async function main() {
  ...
  console.log('Done: uploaded chapters 12..7 from Volume 4 Part 2 and verified content/body.')
}
