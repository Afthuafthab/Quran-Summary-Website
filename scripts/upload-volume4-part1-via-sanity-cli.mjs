...
const INPUT_PATH = '../.hermes/desktop-attachments/Volume 4 part 1.txt'
const TARGET_CHAPTERS = Array.from({length: 7}, (_, i) => 19 - i) // 19..13
...
async function main() {
  ...
  console.log('Done: uploaded chapters 19..13 from Volume 4 Part 1 and verified content/body.')
}
