...
const INPUT_PATH = 'C:/Users/OMEN/Downloads/volume 5 part 2 (1).txt'
const TARGET_CHAPTERS = Array.from({length: 2}, (_, i) => 4 - i) // 4..3
...
async function main() {
  ...
  console.log('Done: uploaded chapters 4..3 from Volume 5 Part 2 and verified content/body.')
}
