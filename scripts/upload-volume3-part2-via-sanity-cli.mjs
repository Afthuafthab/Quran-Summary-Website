...
const INPUT_PATH = '../.hermes/desktop-attachments/Volume 3  part 2.txt'
...
async function main() {
  ...
  console.log('Done: uploaded chapters 30..20 from Volume 3 Part 2 and verified content/body.')
}
