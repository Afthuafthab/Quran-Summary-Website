...
const part1 = fs.readFileSync(path.join(__dirname, 'volume2_raw_part1.txt'), 'utf8');
const part2 = fs.readFileSync(path.join(__dirname, 'volume2_raw_part2.txt'), 'utf8');
const part3 = fs.readFileSync(path.join(__dirname, 'volume2_raw_part3.txt'), 'utf8');
const part4 = fs.readFileSync(path.join(__dirname, 'volume2_raw_part4.txt'), 'utf8');
